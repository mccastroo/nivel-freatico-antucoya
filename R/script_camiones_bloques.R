...
# Variables del Modelo de Bloques de Antucoya en Jigsaw. 
# Esta es identificable en la columna qualities de las tablas de la base de datos.
...
# Este .csv es el que se obtiene de la tabla 'by_custom_cycle_time_detail'

datos_camiones <- readr::read_csv(file = 'Data/camiones_ANT.csv')

# Este .csv es el que obtiene de la tabla grades_qualities
...
# Asignacion información bloque más cercano en tiempo ---------------------
